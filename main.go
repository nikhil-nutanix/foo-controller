...
func main() {
	...
	//flag.IntVar(&zapLogLevel, "zap-log-level", -1, "Zap log level")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "11c87c16.my.domain",
	...
	junoManagerClient, err := juno_manager_client.InitJunoManagerClient(doneChan)
	if err != nil {
